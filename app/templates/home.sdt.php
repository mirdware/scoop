...
<a href="http://mirdware.org"><img src="${ROOT}public/images/scoop.png" alt="scoop" /></a>
...
<h1>Pagina de prueba usando el bootstrap ${app_name}</h1>
...
<form method="post" action="${ROOT}home/send/" enctype="multipart/form-data" target="frame-ajax" class="control-pick" >
